        ...
        $(function () {
           ...
           $("button.addToCart").click(function () {
               ...
               $.getJSON("<%=basePath%>cartServlet","action=ajaxAddItem&id=" + bookId,function (data) {
                    ...
                    $("#cartLaseName").text(data.lastName);
               })
    ...
    <div id="book">
        ...
        <div style="text-align: center">
            <c:if test="${empty sessionScope.cart.items}">
                ...
                <div>
                    <span style="color: red" id="cartLaseName">当前购物车为空</span>
                </div>
            </c:if>
            <c:if test="${not empty sessionScope.cart.items}">
                ...
                <div>
                    您刚刚将<span style="color: red" id="cartLaseName">${sessionScope.lastName}</span>加入到了购物车中
                </div>
            </c:if>
